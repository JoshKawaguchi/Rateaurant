...
public class RestaurantActivity extends AppCompatActivity {
    ...
    public void newRestaurant()
    {
        ...
        restaurant.setCuisine(cuisine.getText().toString() );
        restaurant.setAddress(address.getText().toString());
        restaurant.setWebsiteLink(website.getText().toString());
        restaurant.setRating(( (double) rating.getRating()));
        restaurant.setPrice((int)price.getProgress());

        // save object synchronously
        Restaurant newRestaurant = Backendless.Persistence.save( restaurant );
